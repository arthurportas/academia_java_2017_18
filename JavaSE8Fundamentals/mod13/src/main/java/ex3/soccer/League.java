...
import ex3.utility.PlayerDatabase;
...
public class League {
    ...
    public void showBestTeam(Team[] theTeams) {
        ...
        //using a comparator
        Arrays.sort(theTeams, (team, team2) ->
            Integer.valueOf(team.getPointsTotal()).compareTo(
                    Integer.valueOf(team2.getPointsTotal())
            )
        );

        //equivalent, suggested by intelliJ
        Arrays.sort(theTeams, Comparator.comparing(
                team -> Integer.valueOf(team.getPointsTotal()))
        );
